...
public class CircleProgressBar extends View {
    ...
    public void init(AttributeSet attrs) {
        ...
        outRoundColor = typedArray.getColor(R.styleable.CircleProgressBar_outCircleColor, getResources().getColor(R.color.colorWhite));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.WHITE);            //外圆颜色
