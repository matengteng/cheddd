...
public class LooperTextView extends FrameLayout {
    private List<ContentBean> tipList;
    ...
    private static final String TIP_PREFIX = "元";
    ...
    private void initTipFrame() {
        head_boy = loadDrawable(R.mipmap.back_btn_normal);
        head_girl = loadDrawable(R.mipmap.back_btn_normal);
    ...
    private void updateTip(TextView tipView) {
        ...
        ContentBean tip = getNextTip();
        if (tip!=null&&!TextUtils.isEmpty(tip.getContent())&&!TextUtils.isEmpty(tip.getAmt())) {
            tipView.setText(Html.fromHtml(tip.getContent() +"<font color='#e83d2e'>"+tip.getAmt()+"</font>"+ TIP_PREFIX));
        }
    }
     ...
     * @return
     */
    private ContentBean getNextTip() {
    ...
    public void setTipList(List<ContentBean> tipList) {
