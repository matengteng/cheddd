...
public class LoanActivity extends MyBaseActivity {
    ...
    private void initView() {
        mTnb = (TopNavigationBar) findViewById(R.id.tnb_loan);
        mTabLayoutTitle = (TabLayout) findViewById(R.id.tl_loan_title);
        mViewPageSlide = (ViewPager) findViewById(R.id.vp_loan_slide);
    }
}
